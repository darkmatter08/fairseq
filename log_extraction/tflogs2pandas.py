...
# run as:
# ~/phillytools/projects/pt_transformers/24d1bf66/pt-results/application_1583898264103_223322/logs$ python /home/jains/Documents/fairseq/log_extraction/tflogs2pandas.py valid --write-csv -o valid && python /home/jains/Documents/fairseq/log_extraction/tflogs2pandas.py train --write-csv -o train
...
def main(logdir_or_logfile: str, write_pkl: bool, write_csv: bool, out_dir: str):
    ...
    if os.path.isdir(logdir_or_logfile):
        ...
        print(event_paths)
        print(glob.glob(os.path.join(logdir_or_logfile, "*", "event*")))
